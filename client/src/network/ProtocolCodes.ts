export const LoginServerOpts = {
    LoginServerError: 10,
    LoginServerMotd: 20,
    LoginServerUpdateNeeded: 30,
    LoginServerCharacterList: 100,
} as const;
export type LoginServerOpts = typeof LoginServerOpts[keyof typeof LoginServerOpts];


export const ItemOpcode = {
    StaticText: 96,
    UnknownCreature: 97,
    OutdatedCreature: 98,
    Creature: 99,
} as const;
export type ItemOpcode = typeof ItemOpcode[keyof typeof ItemOpcode];


export const GameServerOpcodes = {
...
export type GameServerOpcodes = typeof GameServerOpcodes[keyof typeof GameServerOpcodes];
...
export type ClientOpcodes = typeof ClientOpcodes[keyof typeof ClientOpcodes];
...
export type CreaturesIdRange = typeof CreaturesIdRange[keyof typeof CreaturesIdRange];
